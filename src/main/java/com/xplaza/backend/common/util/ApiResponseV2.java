...
public class ApiResponseV2<T> {
  ...
  private ApiResponseV2(boolean success, T data, ErrorInfo error, Meta meta) {
  ...
  public static <T> ApiResponseV2<T> ok(T data) {
    return new ApiResponseV2<>(true, data, null, null);
  }

  /**
   * Success response with data and pagination meta
   */
  public static <T> ApiResponseV2<T> ok(T data, PageMeta pagination) {
    return new ApiResponseV2<>(true, data, null, new Meta(pagination, null));
  }

  /**
   * Success response for create operations (201)
   */
  public static <T> ApiResponseV2<T> created(T data) {
    return new ApiResponseV2<>(true, data, null, null);
  }
   ...
   */
  public static ApiResponseV2<Void> ok(String message) {
    return new ApiResponseV2<>(true, null, null, new Meta(null, message));
  }

  /**
   * Empty success response (for 204 No Content scenarios)
   */
  public static ApiResponseV2<Void> noContent() {
    return new ApiResponseV2<>(true, null, null, null);
  }
   ...
   */
  public static <T> ApiResponseV2<T> error(String code, String message) {
    return new ApiResponseV2<>(false, null, new ErrorInfo(code, message, null), null);
  }

  /**
   * Error response with validation details
   */
  public static <T> ApiResponseV2<T> error(String code, String message, Object details) {
    return new ApiResponseV2<>(false, null, new ErrorInfo(code, message, details), null);
  }
