...
/**
 * V2 Product Variation Type Controller - Clean REST API design.
 */
@RestController
@RequestMapping("/api/v2/product-variation-types")
@RequiredArgsConstructor
@Validated
@Tag(name = "Product Variation Type Management V2", description = "V2 APIs for managing product variation types")
public class ProductVariationTypeControllerV2 {
  ...
  public ResponseEntity<ApiResponseV2<List<ProductVariationTypeResponse>>> getProductVariationTypes(
  ...
  public ResponseEntity<ApiResponseV2<ProductVariationTypeResponse>> getProductVariationType(
  ...
  public ResponseEntity<ApiResponseV2<ProductVariationTypeResponse>> createProductVariationType(
  ...
  public ResponseEntity<ApiResponseV2<ProductVariationTypeResponse>> updateProductVariationType(
      @PathVariable @Positive Long id,
      @RequestBody @Valid ProductVariationType productVariationType) {
  ...
  public ResponseEntity<ApiResponseV2<Void>> deleteProductVariationType(@PathVariable @Positive Long id) {
    productVariationTypeService.deleteProductVariationType(id);
    return ResponseEntity.ok(ApiResponseV2.ok("Product variation type deleted successfully"));
  }
}
