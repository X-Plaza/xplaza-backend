...
/**
 * Day Controller - Clean REST API design. Days are reference data (Mon-Sun) -
 * read-only access.
 */
@RestController
...
@Validated
@Tag(name = "Day Reference Data", description = "APIs for accessing day reference data")
public class DayController {
  ...
  public ResponseEntity<ApiResponse<List<DayResponse>>> getDays(
  ...
  public ResponseEntity<ApiResponse<DayResponse>> getDay(@PathVariable @Positive Long id) {
