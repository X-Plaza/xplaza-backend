...
/**
 * Order Item Controller - Clean REST API design.
 */
@RestController
...
public class OrderItemController {
  ...
  public ResponseEntity<ApiResponse<OrderItemResponse>> getOrderItem(@PathVariable @Positive Long id) {
  ...
  public ResponseEntity<ApiResponse<Void>> deleteOrderItem(@PathVariable @Positive Long id) {
    orderItemService.deleteOrderItem(id);
    return ResponseEntity.ok(ApiResponse.ok("Order item deleted successfully"));
  }
}
