...
/**
 * Auth Controller - Unified authentication API.
 *
...
public class AuthController {
  ...
  public ResponseEntity<ApiResponse<Login>> adminLogin(@RequestBody @Valid LoginRequest request) {
    ...
    return ResponseEntity.ok(ApiResponse.ok(loginDetails));
  }
  ...
  public ResponseEntity<ApiResponse<CustomerLoginResponse>> customerLogin(
    ...
    com.xplaza.backend.domain.Customer customer = customerLoginService.getCustomerLoginDetails(username);
    if (customer == null) {
      return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
          .body(ApiResponse.error("INVALID_CREDENTIALS", "Invalid username or password"));
    }
  ...
  public ResponseEntity<ApiResponse<Void>> requestPasswordReset(
    ...
    if (userType == UserType.ADMIN) {
      ...
      if (user == null) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
            .body(ApiResponse.error("USER_NOT_FOUND", "No account found with this email"));
      }
    } else {
    ...
    return ResponseEntity.ok(ApiResponse.ok("OTP has been sent to your email"));
  }
  ...
  public ResponseEntity<ApiResponse<Void>> verifyOTP(
    ...
    if (token == null || !token.getEmail().equals(username)) {
      return ResponseEntity.status(HttpStatus.BAD_REQUEST)
          .body(ApiResponse.error("INVALID_OTP", "OTP is invalid or expired"));
    }
  ...
  public ResponseEntity<ApiResponse<Void>> completePasswordReset(
    ...
    try {
      ...
      return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
          .body(ApiResponse.error("INTERNAL_ERROR", "Failed to reset password"));
    }
  }
